                    ...
                    <td align="center" bgcolor="#ffffff" style="padding: 40px 0;">
                        <table border="0" cellpadding="0" cellspacing="0" style="width:100%;max-width:600px" width="600">
                            <tbody>
                                ...
                                <tr>
                                    <td align="center" style="padding-top:20px;">
                                        <a href="https://barberiaollin.netlify.app/validacion-email" style="display:inline-block;padding:10px 20px;background-color:#f7931e;color:white;text-decoration:none;font-family:Arial,Helvetica,sans-serif;font-size:16px;line-height:26px;border-radius:4px;" target="_blank">
